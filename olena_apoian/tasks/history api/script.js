...
function clickHandler(event) {
    ...
    history.pushState(data, event.target.textContent, event.target.href);  //on this stage back forward buttons change only url NOT content
...
window.addEventListener('popstate', function(event) {
    ...
    updateContent(event.state); // back forward buttons work as intended
});
