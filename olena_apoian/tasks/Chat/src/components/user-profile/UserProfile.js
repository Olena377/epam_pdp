            ...
            <div className="profile">
                ...
                <div className="profile-details">
                    ...
                    <div className="profile-details__block">
                        <img className="profile-details__image" src="../src/img/User.png" alt="User photo" />
                        <h2 className="profile-details__name">{profile_name}</h2>
                        <p className="profile-details__city">{profile_city}</p>
                    </div>
